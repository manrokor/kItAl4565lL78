...
'<center><table class="Octo"><tr><th><p><img src="images/Octocat/octocat-17-130.png" alt="Осьмикот" align="center" style="margin= auto; box-shadow: none; border-radius:130px;"></th> <th class="Octo">Привет, я <strong>ОсьмиКот</strong>!<br><i> Cегодня я забил гол по бразильской системе, а, если бы очки не мешали, забил бы два!</i></p></th></tr></table></center>',    
    ];
